...
let pergunta = ["Qual desses filósofos propôs a classificação das ciências em três grupos: Ciência da Imaginação (poesia), Ciência da Memória (História) e Ciência da Razão (Filosofia)?",
"Quais dessas frases foram ditas por Francis Bacon?",
"Bacon é considerado o pai do empirismo moderno por ter formulado os fundamentos dos métodos de análise e pesquisa da ciência moderna. Pois para ele:",
"Como Emanuel Kant (1724-1804), entendia e defendia o conceito da beleza?",
"Como Kant encara o ‘’Sentimento’’ e o ‘’ Prazer’’?",
"O discurso sobre o Método é obra de qual filosofo?",
"Para Descartes como era a sua base para a formação da Estética?",
"Quais dessas frases são do filósofo René Descartes?Quais dessas frases são do filósofo René Descartes?",
"quais?",
...
let gabarito = ["(A)Francis Bacon (1561-1626)",
"(A)Todas as alternativas.",
"(B)A obtenção dos fatos verdadeiros se dava através da observação e experimentação.",
"(D)É subjetiva.",
"(B)Algo especifico e particular.",
"(C)René Descartes (1596-1650)",
"(B)A obtenção dos fatos verdadeiros se dava através da observação e experimentação.",
"(D)Não há nada no mundo que esteja melhor repartido do que a razão: todos estão convencidos de que a tem de sobra.",
"(A)David Hume (1711-1776)",
"(A)Afirmações extraordinárias necessitam de provas extraordinárias."];  
let fotos = 
["'http://www.afilosofia.com.br/media/images/filosofia-da-educa%C3%A7%C3%A3o.png'",
